      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5F5E5A] text-lg max-w-2xl mx-auto font-light">
            Transparência total. Gere links de propostas interativas onde você e
            seu cliente visualizam exatamente o mesmo escopo, prazos e custos.
          </p>
        </motion.div>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                <div>
                  ...
                  <p className="text-sm text-[#888780] flex items-center gap-2 mt-2">
                    <Users className="w-4 h-4" /> Empresa Nexus Digital ·{' '}
                    <Calendar className="w-4 h-4 ml-1" /> 12 Abr 2026
                  </p>
                </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="text-center md:text-left">
                  <p className="text-xs font-bold text-[#888780] uppercase tracking-wider mb-2">
                    Condições de Pagamento
                  </p>
                  <p className="text-base text-[#1C1C1A] font-medium">
                    Entrada: <span className="font-bold">R$ 5.000</span>{' '}
                    <span className="text-[#888780] mx-2">+</span> 3× de{' '}
                    <span className="font-bold">R$ 4.400</span>
                  </p>
                </div>
