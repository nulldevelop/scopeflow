...
const socialIcons = [
  {
    name: 'Twitter',
    path: 'M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5c6 3 13 0 13-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z',
  },
  {
    name: 'Instagram',
    path: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z',
  },
  {
    name: 'Linkedin',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8 max-w-xs font-light">
              Transformando a precificação de projetos de software em uma
              vantagem competitiva para freelancers e agências.
            </p>
            <div className="flex gap-4">
              {socialIcons.map((icon) => (
                <a
                  key={icon.name}
                  href="#"
                  className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:text-[#9BBFB8] hover:bg-white/10 transition-all"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Funcionalidades', 'Preços', 'Demonstração', 'Roadmap'].map(
                (item) => (
                  <li key={item}>
                    <Link
                      href="#"
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Documentação', 'Guia de Precificação', 'Blog', 'Suporte'].map(
                (item) => (
                  <li key={item}>
                    <Link
                      href="#"
          ...
          <div>
            ...
            <p className="text-white/50 text-sm mb-6 font-light">
              Receba dicas de gestão e precificação toda semana.
            </p>
